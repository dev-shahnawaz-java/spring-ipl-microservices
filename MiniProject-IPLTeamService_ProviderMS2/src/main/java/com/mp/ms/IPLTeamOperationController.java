...
import com.mp.service.IPLTeamMgmtService;
...
@Slf4j  // give Logger obj having name log
public class IPLTeamOperationController {
	...
	public ResponseEntity<String> registerTeam(@RequestBody IPLTeamVO teamVO) throws Exception{
		...
		log.info("register team method -- RestController");
	...
	public ResponseEntity<List<IPLTeamVO>> showAllTeams() throws Exception{
		...
		log.info("Shows all teams method() -- rest controller");
